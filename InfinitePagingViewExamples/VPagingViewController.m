...
- (void)viewDidLoad
{
    ...
    // pagingView
    VerticalInfinitePagingView *pagingView = [[VerticalInfinitePagingView alloc] initWithFrame:CGRectMake(self.view.center.x - 100.f, 0.f, 200.f, self.view.frame.size.height - naviBarHeight)];
