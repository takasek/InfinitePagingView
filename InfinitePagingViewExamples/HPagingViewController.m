...
- (void)pagingViewDidSetPageIndex:(InfinitePagingView *)pagingView lastPageIndex:(NSUInteger)lastPageIndex animated:(BOOL)animated
{
    pageControl.currentPage = pagingView.currentPageIndex;
}
